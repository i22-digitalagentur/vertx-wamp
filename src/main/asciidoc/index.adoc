...
{@link io.vertx.wamp.WAMPWebsocketServer#withSecurityPolicy(SecurityPolicy)} provides a mechanism for fine-grained
control over which client is permitted to perform which action.
