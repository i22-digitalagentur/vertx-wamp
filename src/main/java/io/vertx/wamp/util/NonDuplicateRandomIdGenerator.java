 ...
 *
 * Session IDs as well as subscription and registration IDs have the specific
 * requirement that they are potentially long-lived and as such, ID generation
 * must take care to never re-use IDs of still-running sessions or existing
